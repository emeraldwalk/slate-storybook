...
export interface RenderSpellcheckLeafProps extends RenderLeafProps {
  leaf: Text & { misspelled?: boolean }
}

export const Leaf: React.FC<RenderSpellcheckLeafProps> = ({
  attributes,
  children,
  leaf,
}) => {
  return (
    <span
      style={{ textDecoration: leaf.misspelled ? 'underline' : 'none' }}
      {...attributes}
    >
      {children}
    </span>
...
export const mockWords = commonWords.split('\n').reduce((memo, word) => {
  memo[word] = true
  return memo
